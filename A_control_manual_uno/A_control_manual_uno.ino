...
#define LEDY             7 //VALVE STATUS
#define LEDR             6 //CAM STATUS
#define LEDG             5 //WIRE STATUS
#define LEDB             4 //CAP STATUS
#define VALVE            10 //MUST BE PWM PORT CHANGE *****************
#define CAM              12
#define WIRE             11 //PWM
#define CAP              13 //CHANGE TO 9 LATER
...
void loop()
{
  ...
  if (encoderPosition == 0xFFFF){ //position is bad, let the user know how many times we tried
    ...
    Serial.println(encoderPosition, DEC);} //print the position in decimal format #MIGHT NEED TO REMOVE FOR MANUAL MODE
