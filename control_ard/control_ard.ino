...
/* SPI pins */
#define ENC_0 2     //SPI Chip Select Enc 0
#define ENC_1 3     //SPI Chip Select Enc 1
...
void loop()
{
  ...
  { //position is bad, let the user know how many times we tried
